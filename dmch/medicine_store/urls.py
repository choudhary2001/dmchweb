...
urlpatterns = [
    ...
    path('supply/view/data/', views.supply_details_view_data, name='medicine_supply_details_view_data'),
    ...
    path('supply/medicine/product/<str:medicine_id>/delete/', views.medicine_supply_product_delete_view, name='medicine_supply_product_delete_view'),
    ...
    path('user/medicine/data/print/', views.supply_details_user_view_print_data, name='supply_details_user_view_print_data'),
    ...
    path('itemwise/consumption/show/data/', views.get_consumption_and_remaining_quantityyy_data, name='get_consumption_and_remaining_quantityyy_data'),
    ...
    path('user/medicine/data/aall/', views.supply_details_user_view_data_data, name='supply_details_user_view_data_data'),
